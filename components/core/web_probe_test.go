...
func TestCatalogWebProbeEligibility(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "installed package with unverified probe-required metadata",
			item: catalogItem{
				Installed:        true,
		...
		{
			name: "not-installed package with unverified probe-required metadata",
			item: catalogItem{
				Installed:        false,
		...
		{
			name: "installed unverified package cannot bypass probe-required mode",
			item: catalogItem{
				Installed:        true,
				PackageInstalled: true,
				Trust:            catalogTrust{Status: "unverified"},
		...
		{
			name: "user source remains blocked even if package is installed",
			item: catalogItem{
				Installed:        true,
				PackageInstalled: true,
				Trust:            catalogTrust{Status: "unverified"},
				RegistrySource:   "src-user-test",
				WebPortSource:    "project-default",
				Web:              probeWeb,
			},
			want: false,
