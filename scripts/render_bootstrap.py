...
def main():
    ...
    if target in {"mips-3.4", "mipsel-3.4"}:
        ...
        mips_preview_lines.extend([
            ...
            '            [ "$MIPS_ALLOW_DEGRADED" = "1" ] || fail "Set ROUTERFORGE_MIPS_ALLOW_DEGRADED=1 to explicitly accept degraded operation."',
            '            say "Degraded operation explicitly accepted."',
            '            ;;',
            '        blocked)',
    ...
    lines = [
        ...
        "",
        '    say ""',
        '    say "Detected hardware / ╨Ю╨▒╨╜╨░╤А╤Г╨╢╨╡╨╜╨╜╨╛╨╡ ╨╛╨▒╨╛╤А╤Г╨┤╨╛╨▓╨░╨╜╨╕╨╡:"',
        '    say "RAM: ${ram_mib} MiB"',
        ...
        '        say ""',
        '        say "╨Я╨а╨Х╨Ф╨г╨Я╨а╨Х╨Ц╨Ф╨Х╨Э╨Ш╨Х: ╨╛╨▒╨╜╨░╤А╤Г╨╢╨╡╨╜╨╛ ╤Г╤Б╤В╤А╨╛╨╣╤Б╤В╨▓╨╛ ╤Б 128 ╨Ь╨С ╨Ю╨Ч╨г ╨╕╨╗╨╕ ╨╝╨╡╨╜╤М╤И╨╡ ╨╕ ╨╛╨┤╨╜╨╛╤П╨┤╨╡╤А╨╜╤Л╨╝ ╨┐╤А╨╛╤Ж╨╡╤Б╤Б╨╛╤А╨╛╨╝."',
        '        say "╨г╤Б╤В╨░╨╜╨╛╨▓╨║╨░ RouterForge ╤А╨░╨╖╤А╨╡╤И╨╡╨╜╨░, ╨╜╨╛ ╤Б╤В╨░╨▒╨╕╨╗╤М╨╜╨░╤П ╤А╨░╨▒╨╛╤В╨░ ╨╕ ╨┐╤А╨╛╨╕╨╖╨▓╨╛╨┤╨╕╤В╨╡╨╗╤М╨╜╨╛╤Б╤В╤М ╨╜╨╡ ╨│╨░╤А╨░╨╜╤В╨╕╤А╤Г╤О╤В╤Б╤П."',
        '        if [ "$swap_mib" -gt 0 ]; then',
        '            say "╨Р╨║╤В╨╕╨▓╨╜╤Л╨╣ swap ╨╛╨▒╨╜╨░╤А╤Г╨╢╨╡╨╜: ${swap_mib} MiB."',
        '        else',
        '            say "╨Э╨░╤Б╤В╨╛╤П╤В╨╡╨╗╤М╨╜╨╛ ╤А╨╡╨║╨╛╨╝╨╡╨╜╨┤╤Г╨╡╤В╤Б╤П ╨╜╨░╤Б╤В╤А╨╛╨╕╤В╤М swap-╤А╨░╨╖╨┤╨╡╨╗ ╨╕╨╗╨╕ swap-╤Д╨░╨╣╨╗ ╨╜╨░ USB-╨╜╨░╨║╨╛╨┐╨╕╤В╨╡╨╗╨╡."',
        '        fi',
        '        say ""',
        ...
        '        say ""',
        '        say "╨Я╨а╨Х╨Ф╨г╨Я╨а╨Х╨Ц╨Ф╨Х╨Э╨Ш╨Х: ╨╛╨▒╨╜╨░╤А╤Г╨╢╨╡╨╜╨╛ 128 ╨Ь╨С ╨Ю╨Ч╨г ╨╕╨╗╨╕ ╨╝╨╡╨╜╤М╤И╨╡."',
        '        if [ "$swap_mib" -gt 0 ]; then',
        '            say "╨Р╨║╤В╨╕╨▓╨╜╤Л╨╣ swap ╨╛╨▒╨╜╨░╤А╤Г╨╢╨╡╨╜: ${swap_mib} MiB."',
        '        else',
        '            say "╨Ф╨╗╤П ╤Б╤В╨░╨▒╨╕╨╗╤М╨╜╨╛╨╣ ╤А╨░╨▒╨╛╤В╤Л RouterForge ╤А╨╡╨║╨╛╨╝╨╡╨╜╨┤╤Г╨╡╤В╤Б╤П ╨╜╨░╤Б╤В╤А╨╛╨╕╤В╤М swap-╤А╨░╨╖╨┤╨╡╨╗ ╨╕╨╗╨╕ swap-╤Д╨░╨╣╨╗ ╨╜╨░ USB-╨╜╨░╨║╨╛╨┐╨╕╤В╨╡╨╗╨╡."',
        '        fi',
        '        say ""',
        ...
        '        say ""',
        '        say "╨Я╨а╨Х╨Ф╨г╨Я╨а╨Х╨Ц╨Ф╨Х╨Э╨Ш╨Х: ╨╛╨▒╨╜╨░╤А╤Г╨╢╨╡╨╜ ╨╛╨┤╨╜╨╛╤П╨┤╨╡╤А╨╜╤Л╨╣ ╨┐╤А╨╛╤Ж╨╡╤Б╤Б╨╛╤А."',
        '        say "RouterForge ╨╝╨╛╨╢╨╜╨╛ ╤Г╤Б╤В╨░╨╜╨╛╨▓╨╕╤В╤М, ╨╜╨╛ ╤Б╤В╨░╨▒╨╕╨╗╤М╨╜╨░╤П ╤А╨░╨▒╨╛╤В╨░ ╨╕ ╨┐╤А╨╛╨╕╨╖╨▓╨╛╨┤╨╕╤В╨╡╨╗╤М╨╜╨╛╤Б╤В╤М ╨╜╨░ ╤В╨░╨║╨╛╨╝ ╤Г╤Б╤В╤А╨╛╨╣╤Б╤В╨▓╨╡ ╨╜╨╡ ╨│╨░╤А╨░╨╜╤В╨╕╤А╤Г╤О╤В╤Б╤П."',
        '        say ""',
        ...
        *mips_preview_lines,
        ...
        "",
        "fetch() {",
        '    if [ -x /opt/bin/curl ]; then /opt/bin/curl -q -fL --connect-timeout 10 --max-time 120 -o "$2" "$1"',
        '    elif command -v curl >/dev/null 2>&1; then curl -q -fL --connect-timeout 10 --max-time 120 -o "$2" "$1"',
        ...
        "",
        "verify_core_runtime() {",
        '    health_url="http://127.0.0.1:2233/api/health"',
        '    attempt=1',
        '    while [ "$attempt" -le 10 ]; do',
        '        health=""',
        '        if command -v curl >/dev/null 2>&1; then',
        '            health="$(curl -q --proxy \'\' --noproxy \'*\' -fsS --max-time 3 "$health_url" 2>/dev/null || true)"',
        '        elif [ -x /opt/bin/curl ]; then',
        '            health="$(/opt/bin/curl -q --proxy \'\' --noproxy \'*\' -fsS --max-time 3 "$health_url" 2>/dev/null || true)"',
        '        elif command -v wget >/dev/null 2>&1; then',
        '            health="$(wget -q -T 3 -O - "$health_url" 2>/dev/null || true)"',
        '        elif [ -x /opt/bin/wget ]; then',
        '            health="$(/opt/bin/wget -q -T 3 -O - "$health_url" 2>/dev/null || true)"',
        '        else',
        '            return 1',
        '        fi',
        '        printf \'%s\\n\' "$health" | grep -Eq \'"ok"[[:space:]]*:[[:space:]]*true\' && return 0',
        '        attempt=$((attempt + 1))',
        '        sleep 1',
        '    done',
        '    return 1',
    ...
    lines += [
        "",
        'say "Verifying RouterForge Core runtime..."',
        'verify_core_runtime || fail "RouterForge Core failed local health verification. Check /opt/var/log/routerforge.log."',
        'say "RouterForge Core health: PASS."',
        'say ""',
