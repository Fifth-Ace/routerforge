...
This release intentionally does **not** include P16 Config Vault, P17 completion, or P18 DNS Policy Router from the current Dev/Beta feature line.

Component package versions stay unchanged from Stable 0.9.0:
...
- mips-3.4: experimental; KN-1010 provides physical MIPS evidence.
