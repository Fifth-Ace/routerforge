...
- [NETWORK_TOOLS_CONSOLIDATION.md](NETWORK_TOOLS_CONSOLIDATION.md)
- [RELEASE_PROCESS.md](RELEASE_PROCESS.md)
- [EXECUTABLE_COMPRESSION.md](EXECUTABLE_COMPRESSION.md)
- [VNEXT_MODULES_DEV_FOUNDATION.md](VNEXT_MODULES_DEV_FOUNDATION.md) — исторический/superseded concept.
