...
NAMES = {
    ...
    "routerforge-monitoring": ("RouterForge Monitoring", "RouterForge Monitoring"),
    "routerforge-network-tools": ("RouterForge Network Tools", "RouterForge Network Tools"),
    "routerforge-nfqws-manager": ("RouterForge NFQWS Manager", "RouterForge NFQWS Manager"),
