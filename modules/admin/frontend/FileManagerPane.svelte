...
<style>
  .fm-shell{
    --fm-bg:var(--rf-bg,#0b0d10);--fm-surface:var(--rf-surface,#12151a);--fm-surface-2:var(--rf-surface-2,#171b21);
    --fm-hover:var(--rf-hover,#1d2229);--fm-text:var(--rf-text,#f5f7fa);--fm-muted:var(--rf-muted,#8d98a4);
    --fm-border:var(--rf-border,#29313a);--fm-border-strong:var(--rf-border-strong,#36414d);--fm-accent:var(--rf-accent,#38bdf8);
    --fm-accent-soft:var(--rf-accent-soft,rgba(56,189,248,.10));--fm-accent-hover:var(--rf-accent-hover,rgba(56,189,248,.16));
    --fm-accent-border:var(--rf-accent-border,rgba(56,189,248,.30));
    overflow:hidden;border:1px solid var(--fm-border);border-radius:var(--rf-radius-panel,.72rem);background:var(--fm-surface);color:var(--fm-text)
  }
  ...
  .fm-toolbar{padding:.58rem .68rem;border-bottom:1px solid var(--fm-border);background:var(--fm-surface-2)}
  button,input,select,.search-box,a{font:inherit;color:inherit;border:1px solid var(--fm-border-strong);background:var(--fm-surface-2);border-radius:var(--rf-radius-control,.38rem)}
  button,select,a{padding:.34rem .5rem;cursor:pointer}button:hover,a:hover{background:var(--fm-hover);border-color:var(--fm-accent-border)}button:disabled{opacity:.35;cursor:not-allowed}
  input{padding:.38rem .5rem;outline:0}input:focus{border-color:var(--fm-accent);box-shadow:0 0 0 2px var(--fm-accent-soft)}
  .danger{border-color:rgba(248,81,73,.38)!important;color:var(--bad,#f85149)!important}.spacer{flex:1}.mono{font-family:"Roboto Mono","Cascadia Mono",Consolas,monospace}
  .view-toggle{display:flex}.view-toggle button{border-radius:0}.view-toggle button:first-child{border-radius:var(--rf-radius-control,.38rem) 0 0 var(--rf-radius-control,.38rem)}.view-toggle button:last-child{border-radius:0 var(--rf-radius-control,.38rem) var(--rf-radius-control,.38rem) 0}.view-toggle button.active{background:var(--fm-accent-soft);border-color:var(--fm-accent-border);color:var(--fm-accent)}
  .busy-pill{color:var(--warn,#d29922);font:700 .58rem/1 "Roboto Mono",monospace;letter-spacing:.08em}.fm-ok,.fm-error{padding:.45rem .7rem;font-size:.74rem}.fm-ok{color:var(--good,#2ea043);background:color-mix(in srgb,var(--good,#2ea043) 10%,var(--fm-surface))}.fm-error{color:var(--bad,#f85149);background:color-mix(in srgb,var(--bad,#f85149) 10%,var(--fm-surface))}

  .commander-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:1px;background:var(--fm-border);min-height:35rem}
  .commander-panel{min-width:0;background:var(--fm-bg);outline:2px solid transparent;outline-offset:-2px}.commander-panel.active-panel{outline-color:var(--fm-accent)}
  .panel-nav{padding:.48rem;border-bottom:1px solid var(--fm-border);background:var(--fm-surface)}.panel-nav button{min-width:2rem}.panel-nav select{width:10.5rem;max-width:34%;padding:.34rem .4rem}.path-form{flex:1;min-width:0}.path-input{box-sizing:border-box;width:100%;background:var(--fm-bg);color:var(--fm-text)}
  .panel-filter-row{padding:.38rem .48rem;border-bottom:1px solid var(--fm-border);background:var(--fm-surface)}.panel-filter-row input{min-width:0;flex:1}.panel-filter-row button{padding:.26rem .38rem;font-size:.65rem;color:var(--fm-muted)}.panel-filter-row button.sort-active{color:var(--fm-accent);border-color:var(--fm-accent-border);background:var(--fm-accent-soft)}
  .commander-head,.file-row{display:grid;grid-template-columns:minmax(0,1fr) 6.5rem 10.5rem 8rem;gap:.45rem;align-items:center}.commander-head{padding:.38rem .55rem;background:var(--fm-surface-2);color:var(--fm-muted);font-size:.62rem;font-weight:800;text-transform:uppercase;letter-spacing:.04em;border-bottom:1px solid var(--fm-border)}
  .commander-list{height:52vh;min-height:25rem;overflow:auto;padding:.18rem;scrollbar-color:var(--fm-border-strong) var(--fm-bg)}.file-row{box-sizing:border-box;width:100%;border:0;border-radius:.26rem;padding:.32rem .42rem;background:transparent;text-align:left;color:color-mix(in srgb,var(--fm-text) 88%,var(--fm-muted));font-size:.74rem}.file-row:hover{background:var(--fm-hover)}.file-row.selected{background:var(--fm-accent-soft);color:var(--fm-text);box-shadow:inset 3px 0 var(--fm-accent)}.entry-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.date-cell{font-size:.67rem;color:var(--fm-muted)}.parent-row{opacity:.75}
  .panel-status{min-height:1.9rem;padding:0 .5rem;border-top:1px solid var(--fm-border);background:var(--fm-surface);color:var(--fm-muted);font-size:.61rem}.selected-info{color:color-mix(in srgb,var(--fm-text) 76%,var(--fm-muted));overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
  .commander-keys{padding:.42rem .5rem;background:var(--fm-bg);border-top:1px solid var(--fm-border)}.commander-keys button{display:flex;gap:.32rem;align-items:center;padding:.3rem .46rem}.commander-keys kbd{border:0;background:var(--fm-accent-soft);color:var(--fm-accent);border-radius:.2rem;padding:.08rem .24rem;font:700 .58rem/1 "Roboto Mono",monospace}.key-hint{color:var(--fm-muted);font-size:.59rem}

  .explorer-shell{display:grid;grid-template-columns:13rem minmax(0,1fr);min-height:36rem;background:var(--fm-bg)}.quick-tree{padding:.7rem .55rem;border-right:1px solid var(--fm-border);background:var(--fm-surface);display:flex;flex-direction:column;gap:.18rem}.quick-title{padding:.25rem .45rem .5rem;color:var(--fm-muted);font-size:.62rem;font-weight:800;text-transform:uppercase;letter-spacing:.08em}.quick-tree button{display:grid;grid-template-columns:1.25rem minmax(0,1fr);gap:.06rem .35rem;border:0;text-align:left;background:transparent;padding:.42rem}.quick-tree button small{grid-column:2;color:var(--fm-muted);font-size:.56rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.quick-tree button.active{background:var(--fm-accent-soft);color:var(--fm-accent)}.quick-tree button.active small{color:var(--fm-muted)}.quick-icon{color:var(--fm-accent)}
  .explorer-main{min-width:0;display:grid;grid-template-rows:auto auto 1fr auto}.explorer-toolbar{padding:.55rem .62rem;border-bottom:1px solid var(--fm-border);background:var(--fm-surface-2)}.search-box{display:flex;align-items:center;gap:.3rem;padding:0 .42rem;background:var(--fm-bg)}.search-box input{border:0;background:transparent;box-shadow:none;padding:.35rem 0;min-width:14rem}
  .location-bar{display:flex;align-items:stretch;gap:.7rem;min-width:0;padding:.48rem .62rem;border-bottom:1px solid var(--fm-border);background:var(--fm-surface)}.location-volume{flex:0 0 auto;display:flex;align-items:center;gap:.38rem;padding-right:.65rem;border-right:1px solid var(--fm-border)}.location-volume-name{color:var(--fm-text);font-size:.69rem;font-weight:750;white-space:nowrap}.location-mode{padding:.12rem .3rem;border:1px solid color-mix(in srgb,var(--good,#2ea043) 55%,transparent);border-radius:.28rem;color:var(--good,#2ea043);background:color-mix(in srgb,var(--good,#2ea043) 10%,var(--fm-bg));font:800 .52rem/1 "Roboto Mono",monospace}.location-mode.readonly{border-color:color-mix(in srgb,var(--warn,#d29922) 55%,transparent);color:var(--warn,#d29922);background:color-mix(in srgb,var(--warn,#d29922) 10%,var(--fm-bg))}.location-content{min-width:0;flex:1;display:grid;gap:.1rem}.breadcrumbs{min-width:0;padding:0;color:var(--fm-muted);overflow:auto;white-space:nowrap}.breadcrumbs button{border:0;background:transparent;padding:.08rem .2rem;color:color-mix(in srgb,var(--fm-accent) 74%,var(--fm-muted))}.breadcrumbs button:hover{color:var(--fm-accent);background:var(--fm-accent-soft)}.location-path{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--fm-muted);font-size:.56rem}
  .explorer-table{overflow:auto;max-height:58vh;scrollbar-color:var(--fm-border-strong) var(--fm-bg)}.explorer-head,.explorer-row{display:grid;grid-template-columns:minmax(16rem,1fr) 6.5rem 11rem 8.5rem 10.5rem;gap:.5rem;align-items:center;padding:.42rem .62rem;border-bottom:1px solid var(--fm-border)}.explorer-head{position:sticky;top:0;z-index:3;background:var(--fm-surface-2);color:var(--fm-muted);font-size:.61rem;font-weight:800;text-transform:uppercase;letter-spacing:.04em}.explorer-head button{border:0;background:transparent;padding:0;text-align:left;color:inherit;font-weight:inherit;text-transform:inherit}.explorer-parent-nav{box-sizing:border-box;width:100%;display:flex;align-items:center;gap:.55rem;padding:.5rem .72rem;border:0;border-bottom:1px solid var(--fm-border);border-radius:0;background:var(--fm-surface);color:color-mix(in srgb,var(--fm-text) 74%,var(--fm-muted));text-align:left}.explorer-parent-nav:hover{background:var(--fm-hover);color:var(--fm-text)}.parent-nav-icon{display:grid;place-items:center;width:1.5rem;height:1.5rem;border:1px solid var(--fm-accent-border);border-radius:.35rem;color:var(--fm-accent);background:var(--fm-accent-soft)}.parent-nav-copy{min-width:0;display:flex;align-items:baseline;gap:.65rem}.parent-nav-copy strong{font-size:.72rem;color:inherit}.parent-nav-copy small{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--fm-muted);font-size:.58rem}.explorer-row{font-size:.73rem;min-height:2.2rem}.explorer-row:hover{background:var(--fm-hover)}.explorer-row>button{border:0;background:transparent;text-align:left;padding:0}.entry-open{display:flex;align-items:center;gap:.5rem;min-width:0}.entry-open>span:last-child{display:flex;min-width:0;flex-direction:column}.entry-open strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:.75rem}.entry-open small{color:var(--fm-muted);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font:.56rem/1.2 "Roboto Mono",monospace}.file-icon{width:1.2rem;text-align:center}.permission{color:var(--fm-accent)}.row-actions{display:flex;justify-content:flex-end;gap:.2rem}.row-actions button,.row-actions a{display:grid;place-items:center;width:1.65rem;height:1.65rem;padding:0;text-decoration:none}.explorer-status{padding:.35rem .62rem;border-top:1px solid var(--fm-border);background:var(--fm-surface);color:var(--fm-muted);font-size:.59rem;min-width:0}.explorer-status span:last-child{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.empty-row{padding:1rem;color:var(--fm-muted);text-align:center;font-size:.7rem}.explorer-empty{border-bottom:1px solid var(--fm-border)}

  .volume-select,.tree-volume select{max-width:12rem;background:var(--fm-surface);color:var(--fm-text);border:1px solid var(--fm-border-strong);border-radius:var(--rf-radius-control,.35rem);padding:.34rem .42rem;font:600 .62rem "Roboto Mono",monospace}.tree-volume{padding:.15rem .35rem .65rem;border-bottom:1px solid var(--fm-border);margin-bottom:.45rem}.tree-volume label{display:block;color:var(--fm-muted);font-size:.55rem;font-weight:800;text-transform:uppercase;letter-spacing:.07em;margin-bottom:.28rem}.tree-volume select{width:100%;max-width:none}
  .folder-tree{overflow:auto;max-height:54vh;padding:.1rem 0;scrollbar-color:var(--fm-border-strong) transparent}.tree-row{display:flex;align-items:center;min-width:0;border-radius:.3rem}.tree-row:hover{background:var(--fm-accent-soft)}.tree-row.tree-active{background:var(--fm-accent-soft);box-shadow:inset 2px 0 var(--fm-accent)}.tree-toggle{display:grid!important;place-items:center!important;grid-template-columns:none!important;flex:none;width:1.45rem;height:1.65rem;padding:0!important;border:0;background:transparent;color:var(--fm-muted);font:800 .76rem/1 "Roboto Mono",monospace}.tree-toggle:hover{color:var(--fm-accent);background:var(--fm-accent-hover)}.tree-toggle.loading{color:var(--warn,#d29922)}.tree-toggle.leaf{visibility:hidden}.tree-name{display:flex!important;grid-template-columns:none!important;align-items:center;gap:.3rem;min-width:0;flex:1;border:0;background:transparent;text-align:left;padding:.32rem .2rem!important;color:color-mix(in srgb,var(--fm-text) 84%,var(--fm-muted));white-space:nowrap;overflow:hidden}.tree-name span{min-width:0;overflow:hidden;text-overflow:ellipsis}.tree-active .tree-name{color:var(--fm-accent)}
