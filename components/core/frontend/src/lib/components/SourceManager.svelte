...
<style>
  .source-backdrop,.risk-backdrop{position:fixed;inset:0;z-index:150;background:rgba(0,0,0,.76);display:grid;place-items:center;padding:1.2rem}
  .source-modal{width:min(1040px,96vw);max-height:92vh;overflow:auto;background:var(--rf-panel,var(--panel));border:1px solid var(--rf-border,var(--border));border-radius:1rem;padding:1rem;box-shadow:0 24px 80px rgba(0,0,0,.55)}
  ...
  .risk-modal,.legal-modal{width:min(700px,94vw);max-height:88vh;overflow:auto;background:var(--rf-panel,var(--panel));border:1px solid rgba(255,78,78,.45);border-radius:1rem;padding:1rem;box-shadow:0 24px 80px rgba(0,0,0,.62)}
